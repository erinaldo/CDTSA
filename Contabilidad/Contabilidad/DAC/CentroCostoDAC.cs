...
namespace CG
{
    public static class CentroCostoDAC
    {
        ...
        private static SqlDataAdapter InicializarAdaptador()
        {
            ...
            oAdaptador.SelectCommand.Parameters.Add("@Acumulador", SqlDbType.Bit).SourceColumn = "Acumulador";



            //Paremetros Insert
            oAdaptador.InsertCommand.CommandType = CommandType.StoredProcedure;
            oAdaptador.InsertCommand.Parameters.Add("@Operacion", SqlDbType.NChar).SourceColumn = "I";
            ...
            oAdaptador.UpdateCommand.Parameters.Add("@Operacion", SqlDbType.NChar).SourceColumn = "U";
            ...
            oAdaptador.DeleteCommand.Parameters.Add("@Operacion", SqlDbType.NChar).SourceColumn = "D";
