...
namespace CG.TC {
    ...
    public interface Tipo_Cambio_BCNSoap {
        ...
        CG.TC.RecuperaTC_MesResponse RecuperaTC_Mes(CG.TC.RecuperaTC_MesRequest request);
    }
    ...
    public partial class RecuperaTC_MesRequest {
        ...
        public CG.TC.RecuperaTC_MesRequestBody Body;
        
        public RecuperaTC_MesRequest() {
        }
        
        public RecuperaTC_MesRequest(CG.TC.RecuperaTC_MesRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class RecuperaTC_MesResponse {
        ...
        public CG.TC.RecuperaTC_MesResponseBody Body;
        
        public RecuperaTC_MesResponse() {
        }
        
        public RecuperaTC_MesResponse(CG.TC.RecuperaTC_MesResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Tipo_Cambio_BCNSoapChannel : CG.TC.Tipo_Cambio_BCNSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Tipo_Cambio_BCNSoapClient : System.ServiceModel.ClientBase<CG.TC.Tipo_Cambio_BCNSoap>, CG.TC.Tipo_Cambio_BCNSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CG.TC.RecuperaTC_MesResponse CG.TC.Tipo_Cambio_BCNSoap.RecuperaTC_Mes(CG.TC.RecuperaTC_MesRequest request) {
            return base.Channel.RecuperaTC_Mes(request);
        }
        
        public System.Xml.XmlElement RecuperaTC_Mes(int Ano, int Mes) {
            CG.TC.RecuperaTC_MesRequest inValue = new CG.TC.RecuperaTC_MesRequest();
            inValue.Body = new CG.TC.RecuperaTC_MesRequestBody();
            inValue.Body.Ano = Ano;
            inValue.Body.Mes = Mes;
            CG.TC.RecuperaTC_MesResponse retVal = ((CG.TC.Tipo_Cambio_BCNSoap)(this)).RecuperaTC_Mes(inValue);
