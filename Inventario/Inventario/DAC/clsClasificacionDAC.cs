...
namespace CI.DAC
{
    public  static class clsClasificacionDAC
    {
        ...
        public static DataSet GetClasificacionesSplit(int IDGrupo, string lstClasificaciones)
        {
            String strSQL = "dbo.invGetClasificacionesSplit";

            SqlCommand oCmd = new SqlCommand(strSQL, Security.ConnectionManager.GetConnection());

            oCmd.Parameters.Add(new SqlParameter("@IDGrupo", IDGrupo));
            oCmd.Parameters.Add(new SqlParameter("@lstClasificaciones", lstClasificaciones));
