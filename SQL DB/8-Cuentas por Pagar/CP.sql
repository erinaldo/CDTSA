...
B.Fecha FechaSaldo, B.Saldo, B.Createdate FechaCreateSaldo, C.Orden
...
on D.TipoDocumento = C.TipoDocumento and D.IDClase = C.IDClase inner join dbo.cppProveedor T
...
create PROCEDURE dbo.[uspcppGeneraAsientoSubTipoDoc] @IDProveedor nvarchar(10) , @IDDocumento int , @AsientoOutput nvarchar(10) OUTPUT
as
